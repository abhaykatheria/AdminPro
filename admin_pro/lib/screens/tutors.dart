  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => AddTutor()));
        },
        icon: Icon(Icons.add),
        label: Text('Add Tutor'),
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (_) => AlertDialog(
                                  ...
                                  content:
                                      Text("This will mark all tutors paid"),
                                  actions: <Widget>[
                                    TextButton(
                                      child: Text('Continue'),
                                      onPressed: () async {
                                        for (DocumentSnapshot doc
                                          ...
                                          await FirebaseFirestore.instance
                                              .collection("dues")
                                              .where('tutor',
                                                  isEqualTo: doc['name']).get().then((value) {

                                            FirebaseFirestore.instance
                                                .collection("dues").doc(value.docs[0].id).
