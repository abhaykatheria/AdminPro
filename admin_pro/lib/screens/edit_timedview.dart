...
class EditTimedView extends StatefulWidget {
  // EditTaskView({Key key}) : super(key: key);
  final String id;

  const EditTimedView({Key key, this.id}) : super(key: key);

  @override
  _EditTimedViewState createState() => _EditTimedViewState();
}

class _EditTimedViewState extends State<EditTimedView> {
...
/*
  Future<void> getAssignmentList() async {
    var result = await FirebaseFirestore.instance
        .collection('timed').doc(widget.id).get();
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> UpdateAssignment(Map<String, dynamic> m) {
      ...
      return timed.doc(widget.id).update({
        ...
        showDialog(
          ...
          builder: (_) =>
              AlertDialog(
                title: Text('Timed Assignment Updated'),
                actions: <Widget>[
                  TextButton(
                    child: Text('Continue'),
                    onPressed: () {
